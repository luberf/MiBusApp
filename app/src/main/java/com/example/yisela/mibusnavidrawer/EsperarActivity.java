...
public class EsperarActivity extends AppCompatActivity implements OnMapReadyCallback {
    ...
    {
        String url ="https://maps.googleapis.com/maps/api/directions/json?origin=2.455444,-76.597723&destination=2.438236, -76.616210&key=AIzaSyBoTiQbNu64xRJ4baPrXBMP4PgGlTgHQvA";
